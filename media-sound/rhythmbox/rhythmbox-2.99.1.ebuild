...
COMMON_DEPEND="
	...
	>=media-libs/gst-plugins-base-1.0.5:1.0[introspection]
	>=media-libs/gstreamer-1.0.5:1.0[introspection]
	>=sys-libs/tdb-1.2.6
	dev-libs/json-glib
...
RDEPEND="${COMMON_DEPEND}
	...
	>=media-plugins/gst-plugins-meta-1.0:1.0
	>=media-plugins/gst-plugins-taglib-1.0:1.0

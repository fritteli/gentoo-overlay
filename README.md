...
This is a Gentoo overlay with some ebuilds that I found either outdated or
missing in the official repository or in other overlays. Ebuilds are usually
removed from thisoverlay whenever I find a version available in the official
tree or in another overlay (provided I'm satisfied with them).
...
If you prefer to use the overlay hosted at Codeberg, you may use
`https://codeberg.org/fritteli/gentoo-overlay.git` as the URL.  
If you're a fan of Gitlab, use
`https://gitlab.com/fritteli/gentoo-overlay.git`, and if has to be Github,
use `https://github.com/fritteli/gentoo-overlay.git`.
...
[Codeberg](https://codeberg.org/fritteli/gentoo-overlay/issues) (or on
[GitHub](https://github.com/fritteli/gentoo-overlay/issues), if need be).

...
SRC_URI="
	https://github.com/yuezk/GlobalProtect-openconnect/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	${CARGO_CRATE_URIS}
"
...
cargo_src_install() {
	...
	dobin "${S}/target/x86_64-unknown-linux-gnu/release/gpgui-helper"
	dobin "${S}/target/x86_64-unknown-linux-gnu/release/gpservice"
}
